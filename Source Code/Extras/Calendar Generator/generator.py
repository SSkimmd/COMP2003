...
file_location = str(Path.home()) + "/calendar.ics" ## FilePath 
break_length_options = [-90,-60,-30,0,0,0,15,15,15,30,30,60,90] ##Random event breaks mins 
event_length_options = [15,15,30,30,30,30,30,45,45,60,60,60,60,60,60,60,60,90,90,90,120,120,120,240] ##Random event lengths mins
